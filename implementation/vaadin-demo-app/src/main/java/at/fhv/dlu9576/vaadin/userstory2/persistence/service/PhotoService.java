package at.fhv.dlu9576.vaadin.userstory2.persistence.service;

import at.fhv.dlu9576.vaadin.userstory2.persistence.entity.Photo;
import at.fhv.dlu9576.vaadin.userstory2.persistence.repository.PhotoRepository;
...
public class PhotoService {
    ...
    /**
     * Creates a new {@link Photo} entity and persists saves it to the database.
     *
     * @param fileName   The file name of the uploaded image
     * @param imageData  The image data as {@code byte[]}
     * @param uploadTime The upload time
     */
    public void persistImage(String fileName, byte[] imageData, LocalDateTime uploadTime) {
        LOG.info("Persisting image [{}], uploaded at [{}]", fileName, uploadTime);

        Photo photo = new Photo();
        photo.setFileName(fileName);
        photo.setImageData(imageData);
        photo.setUploadedAt(uploadTime);
