...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.45]{images/SPA_shell_Scott.png}
...
Nachfolgend sind mehrere User Stories aufgelistet, die im Detail erklären, welche Funktionalitäten die Vaadin und Angular Demo-Applikation beinhalten sollen und die genannten Kriterien einfließen lassen.
...
\begin{itemize}
    \item Nutzer:innen können Fotos von ihrem Computer oder Smartphone auswählen und hochladen.
    \item Wenn Fotos von einem anderen Client hochgeladen wurden, kann man diese mit dem aktuellen Gerät synchronisieren, sodass jederzeit alle Fotos offline zur Verfügung stehen.
    \item Wenn keine Internetverbindung vorhanden ist, werden Fotos lokal gespeichert und dann hochgeladen, sobald eine Verbindung wieder zur Verfügung steht.
\end{itemize}

\subsubsection*{User Story 3: TODO}
\label{sub-sec:user-story-3}

\paragraph*{Beschreibung:} TODO
