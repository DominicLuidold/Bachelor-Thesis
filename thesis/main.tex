...
Im Vergleich zur Vaadin Demo hat sich der Programmieraufwand hierbei leicht erhöht, da neben der eigentlichen Anwendung selbst auch ein dazugehöriges Backend entwickelt werden musste, welches Daten entgegennimmt, speichert und zur Verfügung stellt. Da beide Anwendungen auf TypeScript, und somit JavaScript, basieren und die Herangehensweise ähnlich ist, hat dieser Umstand die Entwicklung jedoch nicht spürbar negativ beeinflusst.

Als wichtiger Punkt kommt hinzu, dass die zur Verfügung stehende Dokumentation ausreichend ist und vor allem der große Vorteil besteht, dass sowohl Angular als auch Node.js mit einem \textit{Express}\footnote{\href{https://expressjs.com/}{Express (https://expressjs.com)}} Server sehr weit verbreitet sind. Entsprechende Suchen in den gängigen Suchmaschinen führen zu unzähligen Tutorials, Antworten auf gängige Fragen und Beispielen, die bei der Entwicklung extrem hilfreich sein können.

\clearpage

Lediglich der Umstieg auf einen Mix zwischen HTML, CSS und JavaScript/ TypeScript hat sich bemerkbar gemacht und ist einer der offensichtlichen Punkte, in denen sich Vaadin und Angular unterscheiden. Sowohl der deutlich größere Projektumfang als auch die veränderten Programmierparadigmen erfordern eine kurze Einarbeitungszeit und haben sich während der Entwicklung an gewissen Stellen als Vorteil, an anderen Stellen aber auch als Nachteil erwiesen. Für Entwickler:innen, die bisher noch wenig mit diesen Technologien gearbeitet haben, ist der Einstig jedoch gut möglich und wahrscheinlich etwas leichter, verglichen mit Vaadin und dem objektorientierten Ansatz von Java.
