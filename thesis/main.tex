...
Zusätzlich zu einer vorhandenen Java Umgebung wird \textit{Apache Maven}\footnote{\href{https://maven.apache.org/}{Apache Maven (https://maven.apache.org)}} benötigt, welches standardmäßig alle Abhängigkeiten lädt und verwaltet. Abgesehen von einem gängigen Webbrowser müssen keine zusätzlichen Tools/etc. heruntergeladen werden.
